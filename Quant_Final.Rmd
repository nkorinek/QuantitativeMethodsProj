...
#iterate through rows and then cols
for (r in 1:3){#nrow(my_df)){
  ...
  print(paste('N',fire_mo_name, fire_year, sep=''))

  print(c("match index:",match_idx))
  
  # mapply(function(attr_name, col_idx) {
  #   print(attr_name)
  #   print(col_idx)
  #   my_df[r, attr_name] <- my_df[r,col_idx]
  # }, attr_list, seq(match_idx, match_idx - 24*3, by = -3))
  # 
  # mapply(function(temp_list, col_idx) {
  #   my_df[r, attr_name] <- my_df[r,col_idx]
  # }, attr_list, seq(match_idx, match_idx - 24*3, by = -3))
  # 
  # mapply(function(precip_list, col_idx) {
  #   my_df[r, attr_name] <- my_df[r,col_idx]
  # }, attr_list, seq(match_idx, match_idx - 24*3, by = -3))
...
after_fire_date_cols <- selected_names[sapply(selected_names, function(col_name) {  
  ...
  if(col_date > my_df$fire_date){
    ...
    after_fire_date_cols_keep = c(after_fire_date_cols_keep,col_date)
    return (col_name)
